...
export function presenceStanza(attrs?: Record<string, string>, children?: XmlNode) {
  return h("presence", { xmlns: Namespaces.CLIENT, ...attrs }, children)
}
...
export function queryStanzaPart(attrs: { xmlns: string; [s: string]: string | undefined }, children?: XmlNode) {
